...
sha256sums=(
  ...
  "78d03431538866629ffd32927096f72c38adf101e4164bbc8d0a33b43ddc9319"
)
...
build() {
  ...
  nativefier \
    ...
    --width "800px" \
    --height "600px" \
    --user-agent "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Chrome/113.0.5672.162 Safari/605.1.15" \
